...
##7 segment displayclk_wiz_0.dcpproperty -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { CA }]; #IO_L24N_T3_A00_D16_14 Sch=ca
...
set_input_delay -clock [get_clocks -include_generated_clocks clk_out1_clk_wiz_0] 0.000 [get_ports BTND]
set_output_delay -clock [get_clocks -include_generated_clocks clk_out1_clk_wiz_0] 0.000 [get_ports * -filter direction==out]
